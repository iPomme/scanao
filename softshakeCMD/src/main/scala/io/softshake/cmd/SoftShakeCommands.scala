 ...
 */
@Command(scope = "nao", name = "softShakeDemo", description = "Execute the demonstration of the Softshake demo")
class SoftShakeCommands extends OsgiCommandSupport {
  ...
  protected def doExecute: String = {
    ...
    (demo, key) match {
      ...
      case (Some(s), "count") => demo.get.count(10)
